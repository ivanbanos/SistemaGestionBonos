...
public class ListaSolicitudesEntregaLotesBonosBean {
    ...
    public void init() {
        ...
        if(sessionBean.perfilFormMatch("SolicitudLotes", "crear")){
            lista = sessionBean.marketingFacade.getAllSolicitudentregalotesmaestro();
        } else {
            lista = sessionBean.marketingFacade.getSolicitudentregalotesmaestroNoAceptadas();
        }
    ...
    public void delete() {
        sessionBean.marketingFacade.deleteSolicitudentregalotesmaestro(elemento);
        lista = sessionBean.marketingFacade.getAllSolicitudentregalotesmaestro();
