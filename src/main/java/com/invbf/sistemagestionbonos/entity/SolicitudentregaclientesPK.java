 ...
 */
@Embeddable
public class SolicitudentregaclientesPK implements Serializable {
    ...
    public SolicitudentregaclientesPK() {
    }

    public SolicitudentregaclientesPK(int solicitudEntregaid, int clientesid) {
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof SolicitudentregaclientesPK)) {
            return false;
        }
        SolicitudentregaclientesPK other = (SolicitudentregaclientesPK) object;
    ...
    public String toString() {
        return "com.invbf.sistemagestionbonos.entity.SolicitudentregaclientesPK[ solicitudEntregaid=" + solicitudEntregaid + ", clientesid=" + clientesid + " ]";
    }
