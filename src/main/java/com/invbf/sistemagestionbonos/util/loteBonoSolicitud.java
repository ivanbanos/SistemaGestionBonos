...
public class loteBonoSolicitud {
    ...
    public loteBonoSolicitud(Integer id, Integer cantidad, Lotesbonos lotesBonosid, List<BonosnoincluidosDTO> bonosnoincluidosList) {
        this.id = id;
    ...
    public Solicitudentregalotes getSolicitudEntregaLote() {
        ...
        sol.setBonosnoincluidosList(new ArrayList<Bonosnoincluidos>());
        ...
        for (BonosnoincluidosDTO bonosnoincluidos : bonosnoincluidosList) {
            if (bonosnoincluidos.getConsecutivo() != null && !bonosnoincluidos.getConsecutivo().equals("")&&isBonoDentro(bonosnoincluidos)) {
                ...
                Bonosnoincluidos bni = new Bonosnoincluidos(bonosnoincluidos.getId());
                bni.setConsecutivo(bonosnoincluidos.getConsecutivo());
                sol.getBonosnoincluidosList().add(bni);
            } else {
